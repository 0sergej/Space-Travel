...
INDEX.style.setProperty('background-repeat', 'no-repeat')
INDEX.style.setProperty('background-size', 'cover')

DESTINATION.style.setProperty(
    'background-image',
    'url(../assets/destination/background-destination-desktop.jpg)'
)
DESTINATION.style.setProperty('background-repeat', 'no-repeat')
DESTINATION.style.setProperty('background-size', 'cover')

CREW.style.setProperty(
    'background-image',
