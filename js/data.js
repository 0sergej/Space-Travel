...
sectionImg.setAttribute('src', JSON_DATA.destinations[0].images.png)
sectionWebp.setAttribute('srcset', JSON_DATA.destinations[0].images.webp)
cardHeader.innerHTML = JSON_DATA.destinations[0].name   
cardP.innerHTML = JSON_DATA.destinations[0].description
headerDistance.innerHTML = JSON_DATA.destinations[0].distance
headerTime.innerHTML = JSON_DATA.destinations[0].travel